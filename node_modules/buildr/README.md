...
1. Install Buildr Globally
		...
		npm -g install https://github.com/downloads/brandonramirez/buildr.npm/buildr-0.8.3.tgz

2. Stick your configuration in `buildr.json`
...
1. Install Buildr Locally
		...
		npm install https://github.com/downloads/brandonramirez/buildr.npm/buildr-0.8.3.tgz
...
- v0.8.4 September 6, 2012
  - Allow config file to be specified on command-line via --file or -f (feature request 13 in balupton repository)
  - Display an appropriate error message if the config file doesn't exist
  - Documentation updates
  - Fix issues 20 and 21 (duplicates) from balupton repository.
  - Fix 3 bugs blocking the 'watch' feature from working.

- v0.8.3 September 2, 2012
  - Updated dependencies to fix several bugs
  - Abandoned CSON in favor of JSON.
  - Use cake to build JavaScript, making buildr easier to run
  - Bugs fixed from balupton repo (some as side effects of upgrading dependencies): 8, 19, 23, 25, 27, 28
